...
_STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "portfolio.btn.price": "💲 Цена",
        "portfolio.price.saved": "✅ Для <b>{symbol}</b> задана цена покупки <b>{price} {currency}</b>.",
        ...
        "digest.build.title": "🌅 <b>Доброе утро! Дневной дайджест</b>",
    ...
    "en": {
        ...
        "portfolio.btn.price": "💲 Price",
        "portfolio.price.saved": "✅ Buy price for <b>{symbol}</b> set to <b>{price} {currency}</b>.",
        ...
        "digest.build.title": "🌅 <b>Good morning! Daily digest</b>",
